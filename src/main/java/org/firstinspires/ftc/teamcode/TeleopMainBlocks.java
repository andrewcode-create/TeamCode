...
public class TeleopMainBlocks extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        clawAngleL = hardwareMap.get(Servo.class, "clawAngleL");
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                clawAngleL.setPosition(gamepad1.dpad_right ? 0 : 0.2);
                clawAngleR.setPosition(gamepad1.dpad_right ? 0.57 : 0.4);
                // Do the drivetrain. Left bumper is slow mode, right bumper is reverse the robot.
                // REMEMBER Y STICKS ARE REVERSED!
                DriveTrain(gamepad1.right_bumper ? gamepad1.right_stick_x * (gamepad1.right_bumper ? 1 : 1) : gamepad1.left_stick_x * (gamepad1.right_bumper ? 1 : 1), gamepad1.right_bumper ? -gamepad1.right_stick_y * (gamepad1.right_bumper ? -1 : 1) : -gamepad1.left_stick_y * (gamepad1.right_bumper ? -1 : 1), gamepad1.right_bumper ? gamepad1.left_stick_x * (gamepad1.right_bumper ? 1 : 1) : gamepad1.right_stick_x * (gamepad1.right_bumper ? 1 : 1), gamepad1.right_bumper ? -gamepad1.left_stick_y * (gamepad1.right_bumper ? -1 : 1) : -gamepad1.right_stick_y * (gamepad1.right_bumper ? -1 : 1), gamepad1.left_bumper ? 0.5 : 1, true);
                // Do the claw
                ...
                if (gamepad1.left_trigger != 0 || gamepad1.right_trigger != 0 || gamepad2.left_trigger != 0 || gamepad2.right_trigger != 0 || gamepad1.dpad_up || gamepad1.dpad_down || gamepad2.dpad_up || gamepad2.dpad_down) {
                    RequestPosNumber = -1;
                ...
                // Do slide rotation
                SlideRotate(RequestPosNumber == -1 ? (gamepad1.left_trigger - gamepad1.right_trigger) + (gamepad2.left_trigger - gamepad2.right_trigger) : 0.7, JavaUtil.createListWith(0, 0, 2500), RequestPosNumber, true, 50, -100, 2700);
                ...
                if (LockSlidesAt0) {
                    ...
                    Slides(RequestPosNumber == -1 ? (BoolToInt(gamepad1.dpad_up) - BoolToInt(gamepad1.dpad_down)) + (BoolToInt(gamepad2.dpad_up) - BoolToInt(gamepad2.dpad_down)) : 1, JavaUtil.createListWith(0, 1400, 1800), RequestPosNumber, 100, 100, SlideRemDist, true);
                    // Telemetry
                    TelemetryAll();
                    telemetry.update();
